...
namespace NaturallySpawner
{
    public class NaturSpawner : Script
    {
        ...
        public ModelContainer[] defaultList = new ModelContainer[]
        {
            ...
            new ModelContainer(VehicleHash.Cargobob, new Vector3(-1859, 2795, 33), new Vector3(0, 0, 153), 130000),
            new ModelContainer(VehicleHash.Savage, new Vector3(-1882, 3100, 33), new Vector3(0, 0, 151), 130000),
            ...
            new ModelContainer(VehicleHash.Hunter, new Vector3(-1924, 3127.6f, 34.1f), new Vector3(0, 0, 154.5f), 130000),
            ...
            new ModelContainer(VehicleHash.Cargobob2, new Vector3(-1145, -2864, 14), new Vector3(0, 0, 155), 200000),
            new ModelContainer(VehicleHash.Supervolito, new Vector3(-1178, -2846, 14), new Vector3(0, 0, 155), 200000),

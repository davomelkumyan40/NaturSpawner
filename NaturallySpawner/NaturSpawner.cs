...
namespace NaturallySpawner
{
    public class NaturSpawner : Script
    {
            ...
            modelList = new ModelContainer[]
        {
            ...
            new ModelContainer(VehicleHash.Savage, new Vector3(-1882, 3100, 33), new Vector3(0, 0, 151)),
            ...
            new ModelContainer(VehicleHash.Havok, new Vector3(-2100, 2834.9f, 33.39f), new Vector3(0, 0, -11.3f), VehicleColor.MetallicRed, VehicleColor.MetallicRed),
            new ModelContainer(VehicleHash.Bombushka, new Vector3(-1993.2f, 2850.3f, 33.6f), new Vector3(0, 0, 62)),
